...
# Installation
Pre-build versions are available for Linux and Windows. If you would like to install manually, follow the instructions below. You will need a working python install.
